const VisionSection = () => {
  return (
    <section id="vision" className="py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 bg-gray-50">
        ...
        <div className="text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10 mt-12">
            ...
            <div className="p-8 bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Education Driven</h3>
            ...
            <div className="p-8 bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Health Focused</h3>
