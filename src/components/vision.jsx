        ...
        <div className="text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            ...
            <div className="p-6 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600 text-sm">Building supportive communities that encourage healthy choices.</p>
            </div>
            ...
            <div className="p-6 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Education Driven</h3>
              <p className="text-gray-600 text-sm">Empowering through knowledge and awareness programs.</p>
            </div>
            ...
            <div className="p-6 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600 text-sm">Prioritizing lung health and overall wellbeing for all.</p>
            </div>
          </div>
        </div>
      </div>
