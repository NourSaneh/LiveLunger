      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#vision" className="text-gray-400 hover:text-green-400 transition-colors">Vision</a></li>
              <li><a href="#impact" className="text-gray-400 hover:text-green-400 transition-colors">Impact</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-400 hover:text-green-400 transition-colors">Volunteer</a></li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm">
            © {new Date().getFullYear()} LiveLunger. All rights reserved. Made by Nour Saneh
          </p>
          ...
          <div className="flex space-x-4 mt-4 sm:mt-0">
            ...
            <a href="#" className="text-gray-400 hover:text-green-400 transition-colors" aria-label="TikTok">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
